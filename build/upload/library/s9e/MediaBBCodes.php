...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'flickr'=>array('Flickr','https://www.flickr.com/',array('images'=>1),'!flickr\\.com/photos/[^/]+/(?\'id\'\\d+)!',array('!flickr\\.com/photos/[^/]+/(?\'id\'\\d+)!'),7=>'<iframe width="500" height="500" src="https://www.flickr.com/photos/_/{$id}/player/" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'imdb'=>array('IMDb','http://www.imdb.com/',array('movies'=>1),'!imdb\\.com/video/\\w+/vi(?\'id\'\\d+)!',array('!imdb\\.com/video/\\w+/vi(?\'id\'\\d+)!'),7=>'<iframe width="560" height="315" src="//www.imdb.com/video/imdb/vi{$id}/imdb/embed?autoplay=false&amp;width=560" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'kissvideo'=>array('Kiss Video','http://www.kissvideo.click/index.html',array('videos'=>1),'!kissvideo\\.click/[^_]*_(?\'id\'[0-9a-f]+)!',array('!kissvideo\\.click/[^_]*_(?\'id\'[0-9a-f]+)!'),7=>'<iframe width="640" height="360" src="//www.kissvideo.click/embed.php?vid={$id}" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'nhl'=>array('NHL VideoCenter','http://video.nhl.com/videocenter/',array('sports'=>1),'!nhl\\.com/videocenter/.*?\\Wid=(?\'id\'[-\\w]+)!',array('!nhl\\.com/videocenter/.*?\\Wid=(?\'id\'[-\\w]+)!'),7=>'<iframe width="640" height="395" src="//video.nhl.com/videocenter/embed?playlist={$id}" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'oddshot'=>array('Oddshot','http://oddshot.tv/',array('gaming'=>1),'!(?=.*?[./]oddshot\\.tv[:/]).*?oddshot.tv/shot/(?\'id\'[-\\w]+)!',array('!(?=.*?[./]oddshot\\.tv[:/]).*?oddshot.tv/shot/(?\'id\'[-\\w]+)!'),7=>'<iframe width="560" height="315" src="//oddshot.tv/shot/{$id}/embed" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'streamable'=>array('Streamable','http://streamable.com/',array('videos'=>1),'!streamable\\.com/(?\'id\'\\w+)!',array('!streamable\\.com/(?\'id\'\\w+)!'),7=>'<iframe width="560" height="315" src="//streamable.com/e/{$id}" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'vimeo'=>array('Vimeo','http://vimeo.com/',array('videos'=>1),'!vimeo\\.com/(?:channels/[^/]+/|video/)?(?\'id\'\\d+)!',array('!vimeo\\.com/(?:channels/[^/]+/|video/)?(?\'id\'\\d+)!'),7=>'<iframe width="560" height="315" src="//player.vimeo.com/video/{$id}" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		'vine'=>array('Vine','https://vine.co/',array('social'=>1,'videos'=>1),'!vine\\.co/v/(?\'id\'[^/]+)!',array('!vine\\.co/v/(?\'id\'[^/]+)!'),7=>'<iframe width="480" height="480" src="https://vine.co/v/{$id}/embed/simple?audio=1" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'vox'=>array('Vox','http://www.vox.com/',array('misc'=>1),'!(?=.*?[./]vox\\.com[:/]).*?vox.com/.*#ooid=(?\'id\'[-\\w]+)!',array('!(?=.*?[./]vox\\.com[:/]).*?vox.com/.*#ooid=(?\'id\'[-\\w]+)!'),7=>'<iframe width="560" height="315" src="//player.ooyala.com/iframe.html#pbid=a637d53c5c0a43c7bf4e342886b9d8b0&amp;ec={$id}" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
		...
		'wsj'=>array('The Wall Street Journal Online','http://www.wsj.com/video/',array('news'=>1),"@wsj\\.com/[^#]*#!(?'id'[-0-9A-F]{36})@\n@wsj\\.com/video/[^/]+/(?'id'[-0-9A-F]{36})@\n@(?'id')on\\.wsj\\.com/\\w@",array('@wsj\\.com/[^#]*#!(?\'id\'[-0-9A-F]{36})@','@wsj\\.com/video/[^/]+/(?\'id\'[-0-9A-F]{36})@'),true,array(array('extract'=>array('@guid=(?\'id\'[-0-9A-F]{36})@'),'match'=>array('@on\\.wsj\\.com/\\w@'))),'<iframe width="512" height="288" src="//video-api.wsj.com/api-video/player/iframe.html?guid={$id}" allowfullscreen="" frameborder="0" scrolling="no"></iframe>'),
	...
	*/
	...
	public static function renderAudiomack($vars)
	{
		...
		$html='';if($vars['mode']==='album')$html.='<iframe width="100%" height="340" src="//www.audiomack.com/embed4-album/';else$html.='<iframe width="100%" height="110" src="//www.audiomack.com/embed4/';$html.=htmlspecialchars($vars['id'],2).'" style="max-width:900px" allowfullscreen="" frameborder="0" scrolling="no"></iframe>';
	...
	public static function renderDemocracynow($vars)
	{
		...
		$html='<iframe width="640" height="360" allowfullscreen="" frameborder="0" scrolling="no" src="//www.democracynow.org/embed/';if((strpos($vars['id'],'/headlines')!==false))$html.='headlines/'.htmlspecialchars(strstr($vars['id'],'/headlines',true),2);elseif((strpos($vars['id'],'2')===0))$html.='story/'.htmlspecialchars($vars['id'],2);elseif((strpos($vars['id'],'shows/')===0))$html.='show/'.htmlspecialchars(substr(strstr($vars['id'],'/'),1),2);else$html.=htmlspecialchars($vars['id'],2);$html.='"></iframe>';
	...
	public static function renderHudl($vars)
	{
		...
		$html='<iframe width="640" height="360" src="//www.hudl.com/embed/athlete/'.htmlspecialchars($vars['athlete'],2).'/highlights/'.htmlspecialchars($vars['highlight'],2).'" allowfullscreen="" frameborder="0" scrolling="no"></iframe>';
	...
	public static function renderLivestream($vars)
	{
		...
		$html='<iframe width="640" height="360" allowfullscreen="" frameborder="0" scrolling="no" src="//new.livestream.com/accounts/'.htmlspecialchars($vars['account_id'],2).'/events/'.htmlspecialchars($vars['event_id'],2);if(isset($vars['video_id']))$html.='/videos/'.htmlspecialchars($vars['video_id'],2);$html.='/player?autoPlay=false"></iframe>';
	...
	public static function renderNpr($vars)
	{
		...
		$html='<iframe width="100%" height="228" style="max-width:800px" src="//www.npr.org/player/embed/'.htmlspecialchars($vars['i'],2).'/'.htmlspecialchars($vars['m'],2).'" allowfullscreen="" frameborder="0" scrolling="no"></iframe>';
	...
	public static function renderStitcher($vars)
	{
		...
		$html='<iframe width="100%" height="150" style="max-width:900px" src="//app.stitcher.com/splayer/f/'.htmlspecialchars($vars['fid'],2).'/'.htmlspecialchars($vars['eid'],2).'" allowfullscreen="" frameborder="0" scrolling="no"></iframe>';
